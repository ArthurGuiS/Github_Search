...
import 'package:github_search/models/SearchBloc.dart';
  ...
  Widget _items(SearchItem item) {
    ...
    return ListTile(
      leading: Hero(
        tag: item.url,
        child: CircleAvatar(
          backgroundImage: NetworkImage(item?.avatarUrl ?? //Talvez isso esteja errado!!
      ...
      title: Text(item?.fullName ?? "title"), //Talvez isso esteja errado!!
